...
const accents = ["#211951", "#D4F558", "#836FFE", "#cecece"];
const shuffle = (accent = 0) => [
  // { color: "#857bc1", roughness: 1 },
  { color: "#836FFE", roughness: 0.75 },
