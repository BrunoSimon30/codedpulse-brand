...
const blogPosts: BlogPost[] = [
  ...
  // ... Add all other blog posts following the same structure
];

function OurInsights2() {
    ...
    <section className="section-padding bg-purple blogs_section" ref={main}>
      <Container>
        <div className="blog-card">
          {!isMobile && (
            <Row>
              {/* Left Column - Large Pinned Blog */}
              <Col lg="6" className="mb-lg-0 mb-4">
                <h2 className="heading">Our <br /> insights</h2>
                <Link href="/about-us" className="btn btn-purple mb-4">
                  Know More
                </Link>
              ...
              {/* Right Column - Grid of Smaller Blogs */}
              <Col lg="6">
                <Row>
                  {/* First Inner Column */}
                  <Col md="6">
