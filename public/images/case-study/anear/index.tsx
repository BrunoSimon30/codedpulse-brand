          ...
          <Container>
            <Row>
              <Col lg="5" className="align-self-center mb-lg-0 mb-4">
                ...
                <Link href="/projects" className={`btn ${styles.btn_main}`}>Download Case Study</Link>
              </Col>
          ...
          <Container>
            <Row>
              <Col xl="10" className="text-center mx-auto">
                ...
                <Image src="/images/case-study/anear/group48098907.png" alt="" />
              </Col>
            </Row>
          </Container>
        </section>
          ...
          <Container>
            <Row>
              ...
              <Col lg="5" className="text-lg-end align-self-center">
                <Link href={'#'} className="btn btn-purple">Let’s Suitch</Link>
              </Col>
            </Row>
          </Container>
        </section>
